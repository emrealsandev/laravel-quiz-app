...
class QuizController extends Controller
{
    ...
    public function store(QuizCreateRequest $request)
    {
        ...
        return redirect()->route('quizzes.index')->withSuccess('Başarıyla kaydedildi');
    }
    ...
    {
        $quiz = Quiz::with('topTen.user','results.user')->find($id)->withCount('questions')->first() ?? abort(404,'quiz bulunamadı');

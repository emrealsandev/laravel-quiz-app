    ...
    <div class="card">
        <div class="card-body">
            <h5 class="card-title float-right">
                <a href="{{ route('quizzes.create') }}" class="btn btn-sm btn-success"> <i class="fa fa-plus"></i> Quiz
                    Oluştur</a>
            </h5>
            <form method="GET" action="">
                <div class="form-row">
                    <div class="col-md-4">
                        <input type="text" name="title" value="{{ request()->title }}" class="form-control" placeholder="Quiz adı">
                    </div>
                    <div class="col-md-4">
                        <select name="status" class="form-control" onchange="this.form.submit()">
                            <option disabled>Durum Seçiniz</option>
                        ...
                        <tr>
                            ...
                            <td>
                                @switch($quiz->status)
                                    ...
                                    <span class="badge badge-success">Aktif</span>
                                    @else
                                    <span class="badge badge-danger">Tarihi dolmuş</span>
                                    @endif
                                    @break
                                    @case('passive')
                            ...
                            <td>
                                <a href="{{ route('quizzes.details',$quiz->id) }}" class="btn btn-sm btn-dark"><i class="fa fa-info-circle"></i></a>
